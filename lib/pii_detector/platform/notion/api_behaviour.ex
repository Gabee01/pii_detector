defmodule PIIDetector.Platform.Notion.APIBehaviour do
  ...
  @callback get_database_entries(database_id :: String.t(), token :: String.t() | nil, opts :: Keyword.t()) ::
              {:ok, list(map())} | {:error, any()}

  @callback archive_page(page_id :: String.t(), token :: String.t() | nil, opts :: Keyword.t()) ::
              {:ok, map()} | {:error, any()}

  @callback archive_database_entry(page_id :: String.t(), token :: String.t() | nil, opts :: Keyword.t()) ::
              {:ok, map()} | {:error, any()}
end
